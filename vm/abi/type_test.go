...
func TestTypeRegexp(t *testing.T) {
	tests := []struct {
		...
		{"address", Type{Kind: reflect.Array, Type: addressT, Size: 21, T: AddressTy, stringKind: "address"}},
		{"address[]", Type{T: SliceTy, Kind: reflect.Slice, Type: reflect.TypeOf([]types.Address{}), Elem: &Type{Kind: reflect.Array, Type: addressT, Size: 21, T: AddressTy, stringKind: "address"}, stringKind: "address[]"}},
		{"address[2]", Type{Kind: reflect.Array, T: ArrayTy, Size: 2, Type: reflect.TypeOf([2]types.Address{}), Elem: &Type{Kind: reflect.Array, Type: addressT, Size: 21, T: AddressTy, stringKind: "address"}, stringKind: "address[2]"}},
		{"gid", Type{Kind: reflect.Array, Type: gidT, Size: 10, T: GidTy, stringKind: "gid"}},
		{"gid[]", Type{T: SliceTy, Kind: reflect.Slice, Type: reflect.TypeOf([]types.Gid{}), Elem: &Type{Kind: reflect.Array, Type: gidT, Size: 10, T: GidTy, stringKind: "gid"}, stringKind: "gid[]"}},
		{"gid[2]", Type{Kind: reflect.Array, T: ArrayTy, Size: 2, Type: reflect.TypeOf([2]types.Gid{}), Elem: &Type{Kind: reflect.Array, Type: gidT, Size: 10, T: GidTy, stringKind: "gid"}, stringKind: "gid[2]"}},
		{"tokenId", Type{Kind: reflect.Array, Type: tokenIdT, Size: 10, T: TokenIdTy, stringKind: "tokenId"}},
		{"tokenId[]", Type{T: SliceTy, Kind: reflect.Slice, Type: reflect.TypeOf([]types.TokenTypeId{}), Elem: &Type{Kind: reflect.Array, Type: tokenIdT, Size: 10, T: TokenIdTy, stringKind: "tokenId"}, stringKind: "tokenId[]"}},
		{"tokenId[2]", Type{Kind: reflect.Array, T: ArrayTy, Size: 2, Type: reflect.TypeOf([2]types.TokenTypeId{}), Elem: &Type{Kind: reflect.Array, Type: tokenIdT, Size: 10, T: TokenIdTy, stringKind: "tokenId"}, stringKind: "tokenId[2]"}},
	}
	...
	for _, tt := range tests {
		...
		if !reflect.DeepEqual(typ, tt.kind) {
			t.Errorf("type %q: parsed type mismatch:\nGOT %v\nWANT %v ", tt.blob, typeWithoutStringer(typ), typeWithoutStringer(tt.kind))
		}
	}
}
...
func TestTypeCheck(t *testing.T) {
	for i, test := range []struct {
		...
		{"gid[1]", []types.Gid{{1}}, ""},
		{"gid[1]", [1]types.Gid{{1}}, ""},
		{"gid[2]", [1]types.Gid{{1}}, "abi: cannot use [1]array as type [2]array as argument"},
		{"tokenId[]", []types.TokenTypeId{{1}}, ""},
		{"tokenId[1]", []types.TokenTypeId{{1}}, ""},
		{"tokenId[1]", [1]types.TokenTypeId{{1}}, ""},
		{"tokenId[2]", [1]types.TokenTypeId{{1}}, "abi: cannot use [1]array as type [2]array as argument"},
		{"bytes32", [32]byte{}, ""},
		{"bytes31", [31]byte{}, ""},
		{"bytes30", [30]byte{}, ""},
		{"bytes29", [29]byte{}, ""},
